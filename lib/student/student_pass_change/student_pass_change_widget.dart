...
import 'student_pass_change_model.dart';
export 'student_pass_change_model.dart';

class StudentPassChangeWidget extends StatefulWidget {
  const StudentPassChangeWidget({super.key});

  @override
  State<StudentPassChangeWidget> createState() =>
      _StudentPassChangeWidgetState();
}

class _StudentPassChangeWidgetState extends State<StudentPassChangeWidget>
    with TickerProviderStateMixin {
  late StudentPassChangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentPassChangeModel());
