...
import 'academic_user_model.dart';
export 'academic_user_model.dart';

class AcademicUserWidget extends StatefulWidget {
  const AcademicUserWidget({super.key});

  @override
  State<AcademicUserWidget> createState() => _AcademicUserWidgetState();
}

class _AcademicUserWidgetState extends State<AcademicUserWidget>
    with TickerProviderStateMixin {
  late AcademicUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcademicUserModel());
