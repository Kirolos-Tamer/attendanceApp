...
import 'academic_pass_change_model.dart';
export 'academic_pass_change_model.dart';

class AcademicPassChangeWidget extends StatefulWidget {
  const AcademicPassChangeWidget({super.key});

  @override
  State<AcademicPassChangeWidget> createState() =>
      _AcademicPassChangeWidgetState();
}

class _AcademicPassChangeWidgetState extends State<AcademicPassChangeWidget>
    with TickerProviderStateMixin {
  late AcademicPassChangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcademicPassChangeModel());
